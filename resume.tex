...
{\begin{itemize}
	\item Invented new statistical modeling tool \texttt{pysr3} which does feature selection using non-convex optimization techniques. Implemented it as a  \texttt{scikit-learn}-compatible \texttt{python} package. Achieved 30-fold speed-up upon deployment.
