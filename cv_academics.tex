...
\textbf{Focused on} feature selection and optimization for mixed-effect models.\\
\textbf{Broadly:} statistical models, machine learning, nonconvex optimization.
...
\begin{innerlist}
    \item \href{https://covid19.healthdata.org/united-states-of-america}{IHME Projections for COVID-19}: development and implementation of statistical model that projects cases and deaths from COVID-19 across the world (paper).
    \item \href{https://github.com/aksholokhov/skmixed}{SkMixed}: SciKit-Learn compatible tool for feature selection in mixed models.
\end{innerlist}
\end{outerlist}
...
\vspace{-.125in}
\begin{bibsection}
    \item \href{https://arxiv.org/abs/1811.09863}{Modeling COVID-19 scenarios for the United States.} IHME Covid-19 Forecasting Team (methods contributor). \emph{Nature Medicine}.
\end{bibsection}
